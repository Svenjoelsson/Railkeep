...
<body class="c15" style="100%;">
        ...
        <tbody>
            <tr class="c12">
                <td class="c2" colspan="1" rowspan="1">
                    <p class="c9"><span class="c4">Locomotive:</span></p>
                </td>
                <td class="c2" colspan="1" rowspan="1">
                    <p class="c1"><span class="c0">{{ $unit }}</span></p>
                </td>
                <td class="c2" colspan="1" rowspan="1">
                    <p class="c9"><span class="c4">Order number:</span></p>
                </td>
                <td class="c2" colspan="1" rowspan="1">
                    <p class="c1"><span class="c0">{{ $serviceId }}</span></p>
                </td>
            </tr>
            <tr class="c12">
                <td class="c2" colspan="1" rowspan="1">
    ...
    <table class="c8">
        <tbody>
            <tr class="c3">
                <p class="c9"><span class="c4">Remark/comment:</span></p>
                <td class="c10" colspan="1" rowspan="1">
                    <p class="c1"><span class="c0">{!! nl2br($remarks) !!}</span></p>
                </td>
            </tr>
        </tbody>
    </table>
